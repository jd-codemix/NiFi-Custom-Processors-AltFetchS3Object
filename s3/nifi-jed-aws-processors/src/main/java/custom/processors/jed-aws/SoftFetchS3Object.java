...
@CapabilityDescription("Retrieves the contents of an S3 Object, if the S3 Object exist, and writes it to the content of a FlowFile. Several custom S3 attributes are set. Three custom properties, bulletin, penalize and include-content are available to set.")
@WritesAttributes({
...
public class SoftFetchS3Object extends AbstractS3Processor {
    ...
    public static final PropertyDescriptor INCLUDE_CONTENT = new PropertyDescriptor.Builder()
            ...
            .addValidator(StandardValidators.BOOLEAN_VALIDATOR)
            .allowableValues(new AllowableValue("true", "True", "Include file content."), new AllowableValue("false", "False", "Include file content."))
            .defaultValue("true")
            .build();
